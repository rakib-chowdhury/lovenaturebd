...
<head>
    ...
    <!-- Theme style -->
    <!-- iCheck -->
    <link href="{{url('resources')}}/assets/vantage_home/style.css" rel="stylesheet">
</head>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-4 left-wrapper">
                        <form role="form" action="login/login_check" method="post">
                            {{csrf_field()}}
                            <img class="img-responsive center-block" src="{{url('public')}}/images/logo.png" />
                    ...
                    <div class="col-md-8 col-xs-8 right-wrapper">
                        <img class="img-responsive logo-wasif col-md-offset-2 col-md-8 col-sm-6 col-sm-offset-3" src="{{url('public')}}/images/logo.png">
                    </div>
                </div>
            </div>
        </div>
