...
@section('page_header','Edit Tours & Attractions')
@section('page_breadcrumb')
    <ol class="breadcrumb">
        <li><a href="{{url('home/dashboard')}}">Dashboard</a></li>
        <li><a href="{{url('tours_attractions/show')}}">Tours & Attractions</a></li>
    ...
    <div class="col-sm-12">
        <div class="white-box">
            <form onsubmit=" return chkDoc()" data-toggle="validator" enctype="multipart/form-data"
                  id="info" action="{{url('tour/edit_post')}}" method="post">
                {{csrf_field()}}
                <input type="hidden" name="id" value="{{$tour_info[0]->id}}">
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select required class="form-control" name="country_name"
                                id="country_name">
                            @if(empty($tour_info[0]->hasCountry))
                                <option value="">No Country</option>
                            @else
                                @foreach($country as $row)
                                    <option @if($tour_info[0]->country_id==$row->id){{'selected'}}@endif value="{{ $row->id }}">{{ $row->country_name }}</option>
                                @endforeach
                            @endif
                        </select>
                            <span id="name_err" style="color: red;">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input onblur="check_text_field('name','name_err')"
                               ...
                               value="{{$tour_info[0]->package_code}}">
                            <span id="name_err" style="color: red;">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input onblur="check_text_field('name','name_err')"
                               ...
                               value="{{$tour_info_bn[0]->city_name}}">
                            <span id="name_err" style="color: red;">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input onblur="check_text_field('name','name_err')"
                               ...
                               value="{{$tour_info[0]->package_name}}">
                            <span id="name_err" style="color: red;">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input onblur="check_text_field('name','name_err')"
                               ...
                               value="{{$tour_info_bn[0]->package_name}}">
                            <span id="name_err" style="color: red;">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="summernote" type="text" required class="form-control"
                                  ...
                                  {{$tour_info[0]->package_description}}</textarea>
                            <span id="name_err" style="color: red;">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="summernote" type="text" required class="form-control"
                                  ...
                                  {{$tour_info_bn[0]->package_description}}</textarea>
                            <span id="name_err" style="color: red;">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="summernote" type="text" required class="form-control"
                                  ...
                                  {{$tour_info[0]->tour_details}}</textarea>
                            <span id="name_err" style="color: red;">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="summernote" type="text" required class="form-control"
                                  ...
                                  {{$tour_info_bn[0]->tour_details}}</textarea>
                            <span id="name_err" style="color: red;">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="summernote" type="text" required class="form-control"
                                  ...
                                  {{$tour_info[0]->important_notes}}</textarea>
                            <span id="name_err" style="color: red;">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="summernote" type="text" required class="form-control"
                                  ...
                                  {{$tour_info_bn[0]->important_notes}}</textarea>
                            <span id="name_err" style="color: red;">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="summernote" type="text" required class="form-control"
                                  ...
                                  {{$tour_info[0]->terms_conditions}}</textarea>
                            <span id="name_err" style="color: red;">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="summernote" type="text" required class="form-control"
                                  ...
                                  {{$tour_info_bn[0]->terms_conditions}}</textarea>
                            <span id="name_err" style="color: red;">
                        ...
                        <tr>
                            ...
                            <td>
                                <img style="width: 100px; height: 80px;"
                                     src="{{url('public/images/tour/'.$r->image)}}" alt="">
                            </td>
                            <td>
                                ...
                                <div id="editPic_{{$r->id}}" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <!-- Modal content-->
                                        <form onsubmit="return chkIMG2()" enctype="multipart/form-data" action="{{url('picture/edit_post')}}" method="post">
                                            {{csrf_field()}}
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            <input required type="file"
                                                                   ...
                                                                   data-default-file="{{url('public/images/tour/'.$r->image)}}">
