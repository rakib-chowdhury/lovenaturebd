...
@section('page_title','Hot Deals Type')
@section('page_header','New Hot deal Type')
@section('page_breadcrumb')
    <ol class="breadcrumb">
        <li><a href="{{url('home/dashboard')}}">Dashboard</a></li>
        <li><a href="{{url('hot_deals/show')}}">Hot Deal Type</a></li>
    ...
    <div class="col-sm-12">
        <div class="white-box">
            <form data-toggle="validator" enctype="multipart/form-data"
                  id="info" action="{{url('hot_deals/type_add_post')}}" method="post">
                {{csrf_field()}}
                <div class="row">
