        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1>@if(session('language')=='bn'){{$package_bn[0]->hasCountry->country_name_bn}}{{' '}}
                        {{$package_bn[0]->city_name}}{{' '}}
                        {{$package_bn[0]->hasType->package_type_name_bn}}
                        @else{{$package[0]->hasCountry->country_name}}{{' '}}
                            {{$package[0]->city_name}}{{' '}}
                            {{$package[0]->hasType->package_type_name}}@endif</h1>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h2><span class="atta"
                                          style="color:#003463;">@if(session('language')=='bn'){{'হোটেল সমূহ'}}@else{{'Hotel Category'}}@endif</span>
                                </h2>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 fixed_imgdiv">
                                        <img src="{{url('public')}}/images/hotel/{{$h->hasHotel[0]->hasHotel->image}}"
                                             width="" height="" alt="Hotel Image">
                                        <div style="padding-bottom:5px;" class="hcontent booking_con">
                                            <ul>
                                                <li>
                                                    <b>{{$h->hasHotel[0]->hasHotelBn->hotel_name}}</b>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <b>{{$h->hasHotel[0]->hasHotelBn->hotel_category}}</b>
                                                </li>
                                                <li class="text-justify">
                                                    <b>হোটেলের বিস্তারিত:</b>
                                                </li>
                                                <li>
                                                    <b>{{$h->hasHotel[0]->hasHotelBn->room_category}}</b>
                                                </li>
                                                <li>
                                                    <b>{{$h->hasHotel[0]->hasHotelBn->room_facility}}</b>
                                                </li>
                                                <li>
                                                    <b>{{$h->hasHotel[0]->hasHotelBn->room_price}}</b>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="col-sm-8 fixed_imgdiv">
                                            ...
                                            <div style="padding-bottom:5px;" class="hcontent booking_con">
                                                <ul>
                                                    <li>
                                                        <b>{{$h->hasHotel[0]->hasHotel->hotel_name}}</b>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <b>{{$h->hasHotel[0]->hasHotel->hotel_category}}</b>
                                                    </li>
                                                    <li class="text-justify">
                                                        <b>Hotel Details:</b>
                                                    </li>
                                                    <li>
                                                        <b>{{$h->hasHotel[0]->hasHotel->room_category}}</b>
                                                    </li>
                                                    <li>
                                                        <b>{{$h->hasHotel[0]->hasHotel->room_facility}}</b>
                                                    </li>
                                                    <li>
                                                        <b>{{$h->hasHotel[0]->hasHotel->room_price}}</b>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="" style="text-align: center">
                                            <p>
                                            <p><br></p></p>
                                            <p>@if(session('language')=='bn'){{'সর্বমোট '}}@else{{'Total Amount'}}@endif </p>
                                            <p>@if(session('language')=='bn'){{'পূর্বের মূল্য'}}@else{{'Previous Amount'}}@endif
                                                <?php if($package[0]->discount == 0 ) { ?>
                                            <p class="bdt">BDT {{$package[0]->package_price}}</p>
                                            <?php } else { ?>
                                                <del>{{$package[0]->package_price}}</del>
                                    ...
                                    <div class="clearfix" style="max-width:474px;">
                                        <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                            <li data-thumb="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/42053.jpg">
                                                <img src="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/42053.jpg"
                                            ...
                                            <li data-thumb="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/95808.jpg">
                                                <img src="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/95808.jpg"
                                                     class="img-responsive" style="width:474px;height: 374px;"/>
                                            </li>
                                            <li data-thumb="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/80894.jpg">
                                                <img src="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/80894.jpg"
                                                     class="img-responsive" style="width:474px;height: 374px;"/>
                                            </li>
                                            <li data-thumb="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/43339.jpg">
                                                <img src="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/43339.jpg"
                                                     class="img-responsive" style="width:474px;height: 374px;"/>
                                            </li>
                                            <li data-thumb="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/62070.jpg">
                                                <img src="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/62070.jpg"
                                                     class="img-responsive" style="width:474px;height: 374px;"/>
                                            </li>
                                            <li data-thumb="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/65880.jpg">
                                                <img src="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/65880.jpg"
                                                     class="img-responsive" style="width:474px;height: 374px;"/>
                                            </li>
                                            <li data-thumb="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/40956.jpg">
                                                <img src="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/40956.jpg"
                                                     class="img-responsive" style="width:474px;height: 374px;"/>
                                            </li>
                                            <li data-thumb="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/76968.jpg">
                                                <img src="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/76968.jpg"
                                                     class="img-responsive" style="width:474px;height: 374px;"/>
                                            </li>
                                            <li data-thumb="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/12308.jpg">
                                                <img src="{{url('resources')}}/assets/vantage_home/apanel/tours_and_attractions_image/12308.jpg"
                                                     class="img-responsive" style="width:474px;height: 374px;"/>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="overview">
                            <ul class="nav nav-tabs">
                                <li><a data-toggle="tab"
                                       href="#9">@if(session('language')=='bn'){{'এক নজরে'}}@else{{'Overview'}}@endif</a>
                                </li>
                                <li><a data-toggle="tab"
                                       href="#menu1">@if(session('language')=='bn'){{'গুরুত্বপূর্ণ তথ্যাবলী'}}@else{{'Important Notes'}}@endif </a>
                                </li>
                                <li><a data-toggle="tab"
                                       href="#menu2">@if(session('language')=='bn'){{'শর্তাবলী'}}@else{{'Terms & Conditions'}}@endif </a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div id="9" class="tab-pane fade in active"><br>
                                    <div class="contentwidht" style="color:#000">
                                        <h4 class="oh">
                                            <b>@if(session('language')=='bn'){{'ভ্রমণের বিস্তারিত'}}@else{{'Tour Details'}}@endif </b>
                                        </h4>
                                        <p>
                                        <p>
                                            <!--[if gte mso 9]>
...
mso-bidi-font-weight:bold">@if(session('language')=='bn')<?=$package_bn[0]->tour_details?> @else <?=$package[0]->tour_details?>@endif </span><span
...
Wingdings"><span style="mso-list:Ignore">Ø<span style="font:14px &quot;Times New Roman&quot;">&nbsp;
                                                ...
                                                style="mso-bidi-font-weight:normal">@if(session('language')=='bn')<?=$package_bn[0]->important_notes?> @else <?=$package[0]->important_notes?>@endif</b>
                                    </p>
...
Wingdings"><span style="mso-list:Ignore">Ø<span style="font:14px &quot;Times New Roman&quot;">&nbsp;
                                                ...
                                                style="mso-bidi-font-weight:normal">@if(session('language')=='bn')<?=$package_bn[0]->terms_conditions?> @else <?=$package[0]->terms_conditions?>@endif</b>
                                    </p>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"
                                        id="myModalLabel">@if(session('language')=='bn'){{'বুকিং দিতে যোগাযোগ'}}@else{{'Call For Booking'}}@endif</h4>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <div class="footer-text" style="color:#222;font-size:16px;">
                                        <p>
                                            <b>@if(session('language')=='bn'){{$company_info[0]->company_name_bn}}@else{{$company_info[0]->company_name}}@endif</b><br>
                                            @if(session('language')=='bn') {{$contact_info[0]->address_bn}}@else {{$contact_info[0]->address}}@endif
                                        </p>
                                        <p>
                                            <b>@if(session('language')=='bn') {{'প্যাকেজ সংক্রান্ত তথ্যের জন্য'}}@else {{'For Package Information :'}}@endif </b><br>@if(session('language')=='bn'){{$contact_info[0]->package_info_bn}}@else{{$contact_info[0]->package_info}}@endif
                                        </p>
                                        <p>
                                            <b>@if(session('language')=='bn') {{'এয়ার টিকেট সংক্রান্ত তথ্যের জন্য'}}@else {{'For Air Ticket Information :'}}@endif </b><br>@if(session('language')=='bn'){{$contact_info[0]->air_ticket_info_bn}}@else{{$contact_info[0]->air_ticket_info}}@endif
                                        </p>
                                        <p>
                                            <b>@if(session('language')=='bn') {{'ইমেইল :'}}@else {{'Email:'}}@endif  </b>{{$contact_info[0]->email}}
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    {{--<div class="col-lg-6">--}}
                        ...
                        {{--<div id="Comment_Send_Successfully"></div>--}}
                        {{--<div class="well">Comment</div>--}}
                        {{--<form id="packages_comments" method="post">--}}
                            ...
                            {{--<input type="hidden" name="packcode" value="RM0011"><br>--}}
