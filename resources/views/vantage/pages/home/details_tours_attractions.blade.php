...
@section('content')
    <section id="deals" class="deals">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="color:#14477B">@if(session('language')=='bn'){{$tour[0]->hasCountry->country_name_bn}}{{' '}}{{'ট্যুর এবং আকর্ষণ সমূহ'}}@else{{$tour[0]->hasCountry->country_name}}{{' '}}{{'Tours & Attractions'}}@endif</h1>
                    ...
                    <div class="col-md-6">
                        <div class="booking-left">
                            <div class="package_booking" style="background:#6b6b6b;">
                                <span class="all-hotel">@if(session('language')=='bn'){{$tour_bn[0]->title}}@else{{$tour[0]->title}}@endif</span>
                                <p class="package_booking_para">{{$tour[0]->package_code}}</p>
                            </div>
...
mso-bidi-font-weight:bold">@if(session('language')=='bn')<?=$tour_bn[0]->tour_details?> @else <?=$tour[0]->tour_details?>@endif </span><span style="font-size:14px;font-family:&quot;Times New Roman&quot;,&quot;serif&quot;;mso-fareast-font-family:
...
Wingdings"><span style="mso-list:Ignore">Ø<span style="font:14px &quot;Times New Roman&quot;">&nbsp;
                                            ...
                                            </span><b style="mso-bidi-font-weight:normal">@if(session('language')=='bn')<?=$tour_bn[0]->important_notes?> @else <?=$tour[0]->important_notes?>@endif</b></p>
...
Wingdings"><span style="mso-list:Ignore">Ø<span style="font:14px &quot;Times New Roman&quot;">&nbsp;
                                            ...
                                            </span><b style="mso-bidi-font-weight:normal">@if(session('language')=='bn')<?=$tour_bn[0]->terms_conditions?> @else <?=$tour[0]->terms_conditions?>@endif</b></p>
