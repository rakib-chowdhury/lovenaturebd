    ...
    <div class="navbar-header">
        ...
        <div class="top-left-part">
            <a class="logo" href="<?php echo e(url('/')); ?>">
                <b>
                    <img style="height: 50px; width:125px;" src="<?php echo e(url('resources')); ?>/assets/vantage_home/img/logo.png" alt="Logo"/>
                </b>
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            <li class="dropdown"><a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <i
                ...
                <ul class="dropdown-menu dropdown-user scale-up">
                    ...
                    <li><a href="<?php echo e(url('login/change_password')); ?>"><i class="ti-settings"></i>Change password</a></li>
                    <li role="separator" class="divider"></li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  onsubmit="return checkPass()" action="<?php echo e(url('login/update_password')); ?>" method="post">
