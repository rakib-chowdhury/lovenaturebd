<?php $__env->startSection('page_title','Tours & Attractions'); ?>
<?php $__env->startSection('page_header','Tours & Attractions'); ?>
...
<?php $__env->startSection('page_content'); ?>
    <div class="col-sm-12">
        <div class="white-box">
            <div>
                <!-- Modal -->
                <a href="<?php echo e(url('tour/add')); ?>" style="cursor: pointer;"
                ...
                <table id="myTable" class="table table-striped color-bordered-table success-bordered-table">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; ">
                            ...
                            <a style="cursor: pointer;" href="<?php echo e(url('tour/edit')); ?>/<?php echo e($u->id); ?>">
                                <span data-toggle="tooltip" data-placement="top" title="Edit"
                                      class="glyphicon glyphicon-edit"></span>
                            </a>
                            <!-- Modal -->
                            <a href="<?php echo e(url('tour/delete')); ?>/<?php echo e($u->package_code); ?>">
