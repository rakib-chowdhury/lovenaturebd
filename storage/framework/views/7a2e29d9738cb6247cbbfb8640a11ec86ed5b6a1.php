<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            ...
            <!-----------------------Package----------------->
            <li>
                <a href="<?php echo e(url('hotel/show')); ?>" class="waves-effect">
                    <i class="fa-fw fa fa-shopping-bag" ></i>
                    <span class="hide-menu">Hotels</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(url('transport/show')); ?>" class="waves-effect">
            ...
            <li>
                <a href="<?php echo e(url('tours_attractions/show')); ?>" class="waves-effect">
            ...
            <li>
                <a href="<?php echo e(url('package/show')); ?>" class="waves-effect">
                    <i class="fa-fw fa fa-fire" style=""></i>
            ...
            <li>
                <a href="<?php echo e(url('hot_deals/show')); ?>" class="waves-effect">
                    <i class="fa-fw fa fa-fire" style=""></i>
            ...
            <li>
                <a href="<?php echo e(url('gallery/show')); ?>" class="waves-effect">
                    <i class="fa-fw fa fa-cart-plus" style=""></i>
                    <span class="hide-menu">Gallery</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(url('video/show')); ?>" class="waves-effect">
                    <i class="fa-fw fa fa-cart-plus" style=""></i>
            ...
            <li>
                <a href="<?php echo e(url('about_us/edit')); ?>" class="waves-effect">
                    <i class="fa-fw fa fa-anchor" style=""></i>
                    <span class="hide-menu">About Us</span>
                </a>
            </li>
			 <li>
                <a href="<?php echo e(url('contact/edit')); ?>" class="waves-effect">
