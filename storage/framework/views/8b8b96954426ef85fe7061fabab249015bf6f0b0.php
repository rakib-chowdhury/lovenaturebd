<?php $__env->startSection('page_title','Transports'); ?>
<?php $__env->startSection('page_header','Transports List'); ?>
...
<?php $__env->startSection('page_content'); ?>
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <div>
                <a href="<?php echo e(url('transport/add')); ?>" class="btn btn-success btn-rounded">Add Transport</a>
                <hr>
            </div>
            ...
            <div class="table-responsive">
                <table id="myTable1" class="table table-striped color-bordered-table success-bordered-table">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><?php echo e($u->start); ?></td>
                        <td style="text-align: center;"><?php echo e($u->destination); ?></td>
                        <td style="text-align: center;"><?php echo e($u->transport_name); ?></td>
                        <!-- Modal -->
                        <td style="text-align: center; ">
                            ...
                            <a href="<?php echo e(url('transport/edit')); ?>/<?php echo e($u->id); ?>">
                                <span data-toggle="tooltip" data-placement="top" title="Edit"
                                      class="glyphicon glyphicon-edit"></span>
                            </a>&nbsp;
                            <a href="<?php echo e(url('transport/delete')); ?>/<?php echo e($u->id); ?>">
                                        ...
                                        <div class="modal-body">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding:5px;"><?php echo e($u->vehicle_cost); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:5px;">Transport Name</td>
                                                    <td style="padding:5px;"><?php echo e($u->transport_name); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:5px;">যানবাহনের নাম</td>
                                                    <td style="padding:5px;"><?php echo e($u->transport_name_bn); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:5px;">Start</td>
                                                    <td style="padding:5px;"><?php echo e($u->start); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:5px;">শুরু</td>
                                                    <td style="padding:5px;"><?php echo e($u->start_bn); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:5px;">Destination</td>
                                                    <td style="padding:5px;"><?php echo e($u->destination); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:5px;">গন্তব্য</td>
                                                    <td style="padding:5px;"><?php echo e($u->destination_bn); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:5px;">Transport Category</td>
                                                    <td style="padding:5px;"><?php echo e($u->transport_category); ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:5px;">যানবাহনের বিভাগ(বাংলায়)</td>
                                                    <td style="padding:5px;"><?php echo e($u->transport_category_bn); ?></td>
                                                </tr>
                                                <tr>
